...
namespace ShoeZone
{
    public partial class cüzdanguncelle : Form
    {
        public cüzdanguncelle()
        {
            InitializeComponent();
        }

        private void Cüzdanguncelle_Load(object sender, EventArgs e)
        {
            string b2 = "", b3 = "", b4 = "", b5 = "", b6 = "", b7 = "";
            ((Form1)Application.OpenForms["Form1"]).cuzdanoku(ref b2, ref b3, ref b4, ref b5, ref b6, ref b7); // Form3 Açılır ve bilgisayaroku Fonksiyonu Getirilir.
        ...
        private void Guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            ((Form1)Application.OpenForms["Form1"]).cuzdanguncelle(guna2TextBox2.Text, guna2TextBox3.Text, guna2TextBox4.Text, guna2TextBox5.Text, guna2TextBox6.Text);
            this.Close();
        }
    }
}
